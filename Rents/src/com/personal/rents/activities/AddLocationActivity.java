...
public class AddLocationActivity extends ActionBarActivity {
	...
	public void onSaveBtnClick(View view) {
		...
		String streetNumberText = streetNumberEditText.getText().toString();
		address.streetNumber = !streetNumberText.equals("") 
				? Integer.parseInt(streetNumberText) : 0;
	...
	private void populateAddLocationDetailsPanel(Address address) {
		...
		streetNumberEditText.setText(address.streetNumber > 0 
				? Integer.toString(address.streetNumber) : "");
