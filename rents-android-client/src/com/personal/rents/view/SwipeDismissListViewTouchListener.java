...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
     ...
     * @param callbacks 
     * 			The callback to trigger when the user has indicated that she would like to dismiss
     ...
     * already assigned, the caller should still pass scroll changes through to this listener.
     * This will ensure that this {@link SwipeDismissListViewTouchListener} is paused during list
     * view scrolling.
     */
    ...
    private void performDismiss(final View dismissView, final int dismissPosition) {
        // Animate the dismissed list item to zero-height and fire the dismiss callback when all
    	// dismissed list item animations have completed. This triggers layout on each animation
