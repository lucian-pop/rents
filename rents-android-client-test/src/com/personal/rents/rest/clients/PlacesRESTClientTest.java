...
import com.personal.rents.rest.PlacesRESTClient;
...
public class PlacesRESTClientTest extends AndroidTestCase {
	...
	public void testGetPlacesSuggestions() {
		 List<String> placesNames = PlacesRESTClient.getPlacesSuggestions(INPUT, latitude, 
				 longitude);
	...
	public void testGetPlaceLocation() {
		Address address = PlacesRESTClient.getPlaceLocation(REFERENCE);
